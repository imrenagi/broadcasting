...
import (
	...
	tmetric "github.com/imrenagi/broadcasting/api/internal/telemetry/metric"
	ttrace "github.com/imrenagi/broadcasting/api/internal/telemetry/trace"
	"github.com/imrenagi/broadcasting/api/server/middleware"
)

var name = "broadcasting-api"
...
func NewServer() *Server {
	...
	_, ok = os.LookupEnv("ASYNQ_REDIS_HOST")
	if !ok {
